...
const mobRules = {
    ...
    <ol>
        <li>
            **Determine the Roll Needed**: Calculate the minimum d20 roll for success:
            // Process: $$Roll\ Needed = Target\ Number - Monster's\ Bonus$$
    ...
    discord: {
        ...
        fields: [
            ...
            {
                // Process: name: "Step 1: Determine Roll Needed",
            ...
            {
                // Process: name: "Step 2: Find Roll on Table",
            ...
            {
                // Process: name: "Step 3: Find Success Fraction",
...
// Process: module.exports =  mobRules
