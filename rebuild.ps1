...
if (-not (Invoke-WithRetry -Command "git" -Arguments @("checkout", $TargetBranch, "||", "git", "checkout", "-b", $TargetBranch, "origin/$TargetBranch") -ErrorName "Git Checkout" -WorkingDirectory $GitWorkingDir)) { exit 1 }
