...
2.  At least one audio file (e.g., MP3, WAV) available on your computer to use as a main music track.
3.  Ensure your Discord bot is configured and running in a voice channel.
...
4.  **Expected Result:**
    *   You should hear a notification jingle through your Discord bot.
...
6.  **Expected Result:**
    *   The music should begin playing through your Discord bot.
    *   The log panel should show messages related to caching the file and starting playback.
    *   **There should be NO "Only one input stream is supported" errors in the log.**
...
3.  **Expected Result:**
    ...
    *   You should hear the notification jingle play *over* the music.
